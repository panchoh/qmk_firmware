...
/*
 * Copyright © 2023-2026 pancho horrillo <pancho@pancho.name>
 *
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [L_FN] = LAYOUT_ansi_89(
        ...
        _______,  KC_CAPS,  _______,  _______,  _______,  _______,  _______,   _______,  _______,  _______,  _______,  _______,  _______,            _______,            KC_END,
