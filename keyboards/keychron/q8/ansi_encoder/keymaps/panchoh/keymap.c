...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [LNX_BASE] = LAYOUT_ansi_69(
        ...
        KC_LCTL,   KC_LALT,  KC_LWIN,           KC_SPC,           MO(L_FN), MO(L_FN),          KC_SPC,            KC_RALT,            KC_LEFT,  KC_DOWN,  KC_RGHT),
    ...
    [WIN_BASE] = LAYOUT_ansi_69(
        ...
        KC_LCTL,   KC_LALT,  KC_LWIN,           KC_SPC,           MO(W_FN), MO(W_FN),          KC_SPC,            KC_RALT,            KC_LEFT,  KC_DOWN,  KC_RGHT),
